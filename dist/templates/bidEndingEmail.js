...
exports.bidEndingHtml = void 0;
const bidEndingHtml = (images, title) => {
  ...
  <h1 style="margin: 0; color: #101010; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 27px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 32.4px;"><strong>${title} <br/> Time is running out!
</strong></h1>
  </td>
  </tr>
  </table>
  ...
  <p style="margin: 0; word-break: break-word;"><span>With just 10 minutes left on the clock, it's time to make your move.  </span></p>
  </div>
  </td>
  </tr>
  </table>
...
exports.bidEndingHtml = bidEndingHtml;
