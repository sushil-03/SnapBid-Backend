...
exports.bidPaymentHTML = void 0;
const bidPaymentHTML = (images, title, bid, minuteLeft) => {
    const hostLink = "https://snap-bid.vercel.app/";
    return `<!DOCTYPE html>
  ...
  <div style="max-width: 147.333px;"><img alt="Snapbid" height="auto" src="https://res.cloudinary.com/dlv5hu0eq/image/upload/v1714386207/bidding/vdsgat9ts573k4d9vj8h.png" style="display: block; height: auto; border: 0; width: 100%;" title="Company Logo" width="147.333"/></div>
  </div>
  </td>
  </tr>
  </table>
  ...
  <div align="center" class="alignment" style="line-height:10px">
  <div style="max-width: 680px;"><img alt="Top round corners" height="auto" src="https://res.cloudinary.com/dlv5hu0eq/image/upload/v1714414063/bidding/icons/kagns665dr8fbknierur.png" style="display: block; height: auto; border: 0; width: 100%;" title="Top round corners" width="680"/></div>
  </div>
  </td>
  </tr>
  </table>
  ...
  <td class="pad">
  <div align="center" class="alignment" style="line-height:10px">
  <div class="fullWidth" style="max-width: 374px;"><img alt=${title} height="auto" src=${images} style="display: block; height: auto; border: 0; width: 100%;" title=${title} width="374"/></div>
  </div>
  </td>
  </tr>
  </table>
  ...
  <h1 style="margin: 0; color: #101010; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 27px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 32.4px;"><strong>${title}<br/> One Step Away!</strong></h1>
  </td>
  </tr>
  </table>
  </td>
  ...
  <p style="margin: 0; word-break: break-word;"><span>Congratulations on securing your chance! You're now ready to proceed with payment.</span></p>
  </div>
  </td>
  </tr>
  </table>
  ...
  <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="www.example.com" style="height:48px;width:162px;v-text-anchor:middle;" arcsize="10%" strokeweight="0.75pt" strokecolor="#101" fillcolor="#101">
  <w:anchorlock/>
  <v:textbox inset="0px,0px,0px,0px">
  <center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px">
  <![endif]--><a href=${hostLink} style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#101;border-radius:4px;width:auto;border-top:1px solid #101;font-weight:undefined;border-right:1px solid #101;border-bottom:1px solid #101;border-left:1px solid #101;padding-top:5px;padding-bottom:5px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;" target="_blank"><span style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="word-break: break-word; line-height: 32px;">Pay Now  $${bid}</span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>
  <div
  style="font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:12px;text-align:center; margin-top: 5px; color:gray;">
  Act now! Only ${minuteLeft}min left to pay before it expires.</div>
  </td>
  </tr>
  </table>
  ...
  <td class="pad" style="width:100%;">
  <div align="center" class="alignment" style="line-height:10px">
  <div style="max-width: 680px;"><img alt="Bottom round corners" height="auto" src="https://res.cloudinary.com/dlv5hu0eq/image/upload/v1714414063/bidding/icons/uor7ojt6h9w3ncsr2fji.png" style="display: block; height: auto; border: 0; width: 100%;" title="Bottom round corners" width="680"/></div>
  </div>
  </td>
  </tr>
  </table>
  ...
  <tr>
  <td style="padding:0 2px 0 2px;"><a href="https://www.facebook.com" target="_blank"><img alt="Facebook" height="auto"
    src="https://res.cloudinary.com/dlv5hu0eq/image/upload/v1714413921/bidding/icons/ugwttyqllehwspg0bcmj.png"
                                          
      style="display: block; height: auto; border: 0;" title="facebook" width="32"/></a></td>
  <td style="padding:0 2px 0 2px;"><a href="https://www.twitter.com" target="_blank"><img alt="Twitter" height="auto" 
    src="https://res.cloudinary.com/dlv5hu0eq/image/upload/v1714413922/bidding/icons/jkkv02r3pknqf2yj7jct.png"
                                             style="display: block; height: auto; border: 0;" title="twitter" width="32"/></a></td>
  <td style="padding:0 2px 0 2px;"><a href="https://www.linkedin.com" target="_blank"><img alt="Linkedin" height="auto"    src="https://res.cloudinary.com/dlv5hu0eq/image/upload/v1714413922/bidding/icons/xcmsh7itpxefci3nleqd.png"
    style="display: block; height: auto; border: 0;" title="linkedin" width="32"/></a></td>
  <td style="padding:0 2px 0 2px;"><a href="https://www.instagram.com" target="_blank"><img alt="Instagram" height="auto"    src="https://res.cloudinary.com/dlv5hu0eq/image/upload/v1714413922/bidding/icons/ibif4lssonqsrklnmbcq.png"
  ...
  <div class="menu-links"><!--[if mso]><table role="presentation" border="0" cellpadding="0" cellspacing="0" align="center" style=""><tr style="text-align:center;"><![endif]--><!--[if mso]><td style="padding-top:5px;padding-right:15px;padding-bottom:5px;padding-left:15px"><![endif]--><a href=${hostLink} style="mso-hide:false;padding-top:5px;padding-bottom:5px;padding-left:15px;padding-right:15px;display:inline-block;color:#101010;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;text-decoration:none;letter-spacing:normal;" target="_self">Unsubscribe</a><!--[if mso]></td><![endif]--><!--[if mso]><td style="padding-top:5px;padding-right:15px;padding-bottom:5px;padding-left:15px"><![endif]--><a href=${hostLink} style="mso-hide:false;padding-top:5px;padding-bottom:5px;padding-left:15px;padding-right:15px;display:inline-block;color:#101010;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;text-decoration:none;letter-spacing:normal;" target="_self">Help</a><!--[if mso]></td><![endif]--><!--[if mso]><td style="padding-top:5px;padding-right:15px;padding-bottom:5px;padding-left:15px"><![endif]--><a href="${hostLink}/auth" style="mso-hide:false;padding-top:5px;padding-bottom:5px;padding-left:15px;padding-right:15px;display:inline-block;color:#101010;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;text-decoration:none;letter-spacing:normal;" target="_self">Login</a><!--[if mso]></td><![endif]--><!--[if mso]><td style="padding-top:5px;padding-right:15px;padding-bottom:5px;padding-left:15px"><![endif]--><a href=${hostLink} style="mso-hide:false;padding-top:5px;padding-bottom:5px;padding-left:15px;padding-right:15px;display:inline-block;color:#101010;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;text-decoration:none;letter-spacing:normal;" target="_self">Privacy</a><!--[if mso]></td><![endif]--><!--[if mso]></tr></table><![endif]--></div>
  </td>
  </tr>
  </table>
  </td>
...
exports.bidPaymentHTML = bidPaymentHTML;
