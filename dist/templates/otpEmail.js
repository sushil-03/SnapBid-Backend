...
const otpHTML = (OTP) => {
  ...
  <td class="pad">
  <div align="center" class="alignment" style="line-height:10px">
  <div class="fullWidth" style="max-width: 374px;"><img alt="otp" height="auto" src="https://res.cloudinary.com/dlv5hu0eq/image/upload/v1714764045/bidding/irbpjhyxms3iwyvsuqoj.png" style="display: block; height: auto; border: 0; width: 100%;" title="otp" width="374"/></div>
  </div>
  </td>
  </tr>
  </table>
  ...
  <h1 style="margin: 0; color: #101010; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 27px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 32.4px;"><strong>Your one-time code is</h1>
  </td>
  </tr>
  </table>
  </td>
  ...
  <p style="margin: 0; word-break: break-word;"><span>Please verify you're really you by entering this 4-digit code when you sign in. Just a heads up, this code will expire in 20 minutes for security reasons.</span></p>
  </div>
  </td>
  </tr>
  </table>
  ...
  <![endif]--><div  style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#101;border-radius:4px;width:auto;border-top:1px solid #101;font-weight:undefined;border-right:1px solid #101;border-bottom:1px solid #101;border-left:1px solid #101;padding-top:5px;padding-bottom:5px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;" target="_blank"><span style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="word-break: break-word; line-height: 32px;">${OTP}</span></span></div><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>
  <div
